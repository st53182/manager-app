...
/* ===== ДЕМО-ПАНЕЛЬ ===== */
const DEMO_PROMPTS = {
  landing: `Создай красивый landing page на русском языке для SaaS-продукта «Pulse» — AI-платформы для управления командой и эффективностью сотрудников.

КРИТИЧЕСКИ ВАЖНО: твой ответ должен содержать ТОЛЬКО блок кода ниже — никакого вступительного текста, никаких пояснений, никаких предупреждений до или после. Просто код:
...
Требования:
— Все стили встроены в <style> внутри <head>, Google Fonts через @import (Inter)
— Никаких внешних JS-библиотек

Секции лендинга:
1. Навбар — логотип Pulse, меню (Возможности / Цены / Команда), кнопка «Начать бесплатно»
2. Hero — заголовок «Управляйте командой с силой ИИ», подзаголовок, две кнопки, красивый SVG-дашборд справа
3. Логотипы клиентов — 5 известных компаний текстом в строку
4. Возможности — 3 карточки: AI-аналитика производительности / Умные 1:1 встречи / Прогноз выгорания
5. Цифры — 3 большие метрики: «+34% продуктивность», «2× быстрее онбординг», «89% NPS»
6. Отзывы — 3 карточки с именем, должностью, компанией и цитатой
7. Тарифы — 3 плана (Старт / Про / Энтерпрайз) с ценами и списком функций
8. CTA-баннер — градиентный блок «Попробуйте 14 дней бесплатно»
9. Footer — ссылки, соцсети, copyright

Дизайн: тёмный градиентный hero (#0f172a → #1e1b4b), белые секции, акцент фиолетовый #7c3aed и голубой #06b6d4. Карточки с тенями, hover-эффекты, скруглённые края. Современный SaaS-стиль как у Linear или Notion.`,
