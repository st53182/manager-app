...
ВАЖНО: Весь ответ — это ТОЛЬКО один блок кода, никакого текста до или после. Оберни HTML строго так:
...
Требования к HTML: встроенные стили CSS, никаких внешних зависимостей кроме Google Fonts (@import Inter или Nunito).
